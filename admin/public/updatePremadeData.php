<?php
	...
	$update_sql = "UPDATE main_premade SET label='".$label."', description='".$description."', img='".$img."', label_de='".$label_de."', description_de='".$description_de."', label_de='".$label_de."', description_de='".$description_de."', price=".$price." WHERE id=".$id;
